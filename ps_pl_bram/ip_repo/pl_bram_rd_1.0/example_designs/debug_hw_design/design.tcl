...
proc create_ipi_design { offsetfile design_name } {
	...
	set pl_bram_rd_0 [ create_bd_cell -type ip -vlnv user.org:user:pl_bram_rd:1.0 pl_bram_rd_0 ]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:pl_bram_rd:1.0]]]]
